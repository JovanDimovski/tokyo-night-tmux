...
right_append="$($SCRIPTS_PATH/right_append.sh)"
...
#+--- Bars RIGHT ---+
tmux set -g status-right "$RESET $docker$battery_status$current_path$cmus_status$netspeed$git_status$wb_git_status$date_and_time$right_append"
