...
#+--- Bars LEFT ---+
# Session name
tmux set -g status-left "#{?client_prefix,#[fg=${THEME[blue]},bg=${THEME[bblack]},bold] #S ,#[fg=${THEME[bblack]},bg=${THEME[green]},bold] #S }"
...
#+--- Bars RIGHT ---+
tmux set -g status-right "#[fg=#cc7700] #{docker_status}$RESET $battery_status$current_path$cmus_status$netspeed$git_status$wb_git_status$date_and_time"
